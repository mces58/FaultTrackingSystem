...
namespace FaultTrackingSystem.FaultTracking.Main.Customer.Parent
{
    public partial class ForgetPassword : Form
    {
        ...
        // lnklblNewAccount animasyon
        private void LnklblNewAccount_MouseEnter(object sender, EventArgs e)
        {
            lnklblNewAccount.Font = new Font("Segoe UI Black", 10F, ((FontStyle)((FontStyle.Bold | FontStyle.Italic))), GraphicsUnit.Point, ((byte)(0)));
            lnklblNewAccount.LinkColor = Color.FromArgb(248, 8, 68);
            lnklblNewAccount.LinkBehavior = LinkBehavior.NeverUnderline;
        }

        // lnklblNewAccount animasyon
        private void LnklblNewAccount_MouseLeave(object sender, EventArgs e)
        {
            lnklblNewAccount.Font = new Font("Segoe UI Black", 9.75F, ((FontStyle)((FontStyle.Bold | FontStyle.Italic))), GraphicsUnit.Point, ((byte)(0)));
            lnklblNewAccount.LinkColor = Color.Silver;
            lnklblNewAccount.LinkBehavior = LinkBehavior.AlwaysUnderline;
        }
        ...
        private void BtnSend_Click(object sender, EventArgs e)
        {
            ...
            pnlHorizonal3.Location = new Point(85, 575);
            lblOr.Location = new Point(200, 565);
            lblOr.BringToFront();
            lnklblNewAccount.Location = new Point(162, 600);
        ...
        // sifreyi degis
        private void ChangePassword(string newPassword, string emailAddress)
        {
            try
            {
                // baglanti islemleri
                connection = new SqlConnection(connectionUrl);
                // sql sorgusu
                string query = "UPDATE Customer SET PasswordHash = @PasswordHash WHERE EmailAddress = @EmailAddress";
                sqlCommand = new SqlCommand(query, connection);
        ...
        {
            string newPassword = HashString(txtNewPassword.Text);
            ...
            ChangePassword(newPassword, emailAddress);
        ...
        // musteri sifremi unuttum sayfasinin yuklenmesi
