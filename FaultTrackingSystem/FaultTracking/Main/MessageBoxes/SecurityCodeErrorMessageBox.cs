...
{
    public partial class SecurityCodeErrorMessageBox : Form
    {
        ...
        // constructor
        public SecurityCodeErrorMessageBox()
        {
            InitializeComponent();
        }

        // sayfa yuklenirken
        private void SecurityCodeErrorMessageBox_Load(object sender, EventArgs e)
        {
            // border-radius
