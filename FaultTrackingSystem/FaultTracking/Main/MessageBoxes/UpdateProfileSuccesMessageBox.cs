...
{
    public partial class UpdateProfileSuccesMessageBox : Form
    {
        ...
        // constructor
        public UpdateProfileSuccesMessageBox()
        {
            InitializeComponent();
        }

        // sayfa yuklenirken
        private void UpdateProfileSuccesMessageBox_Load(object sender, EventArgs e)
        {
