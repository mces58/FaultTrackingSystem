...
{
    public partial class EmployeeLoginErrorMessageBox : Form
    {
        ...
        // constructor
        public EmployeeLoginErrorMessageBox()
        {
            InitializeComponent();
        }

        // sayfa yuklenirken
        private void EmployeeLoginErrorMessageBox_Load(object sender, EventArgs e)
        {
            // border radius
