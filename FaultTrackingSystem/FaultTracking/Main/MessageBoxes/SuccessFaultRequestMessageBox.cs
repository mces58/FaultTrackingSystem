...
{
    public partial class SuccessFaultRequestMessageBox : Form
    {
        ...
        // constructor
        public SuccessFaultRequestMessageBox()
        {
            InitializeComponent();
        }

        // sayfa yuklenirken
        private void SuccessFaultRequestMessageBox_Load(object sender, EventArgs e)
        {
            // border-radius
